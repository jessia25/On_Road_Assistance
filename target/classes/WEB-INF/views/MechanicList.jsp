...
<title>On Road Assistance - List of Mechanics</title>
					...
					<tbody>
						<c:forEach items="${ratingList}" var="rating">
							<tr>
								...
								<td>${rating.mechanicId }</td>
								<td>${rating.avg}</td>
								<td>
									<form action = "/On_Road_Assistance/search/${requestId }/${rating.mechanicId }">
										<button type="submit" class="btn btn-primary btn-sm">See Details</button>
									</form>
								</td>
							</tr>
						</c:forEach>
