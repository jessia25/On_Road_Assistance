...
<title>On Road Assistance - Requests</title>
...
<body>
	...
	<div
		...
		<div class="shadow   p-5 mt-5 text-center container">
			<c:if test="${!empty activeRequestList }">
					...
					<tbody>
						<c:forEach items="${activeRequestList }" var="request">
							<tr>
								...
								<c:if test="${(request.status == 'wait') }">
									<td class="d-flex justify-content-around">
										<button class="btn btn-primary btn-sm"
											onclick="window.location.href='/On_Road_Assistance/mechanicAccept/${request.requestId}';">
											<strong>Accept</strong>
										</button>
									<button class="btn btn-primary btn-sm"
											onclick="window.location.href='/On_Road_Assistance/mechanicReject/${request.requestId}';">
